...
class LatestProductManager:
    ...
    def get_products_for_main_page(*args, **kwargs):
        ...
        products = []
        ct_models = ContentType.objects.filter(model__in)
...
class CategoryManager(models.Manager):
    ...
    def get_categories_for_left_sidebar(self):
        ...
        data = [
            dict(name=c.name, url=c.get_absolute_url(), count=getattr(c, self.CATEGORY_NAME_CATEGORY_COUNT[c.name])) for c in qs
        ]
        return data
...
class Customer(models.Model):
    ...
    phone = models.CharField(max_length=255, verbose_name='Адрес')
